...
export default function Header() {
  return (
    <header className=" w-full sticky top-0 py-6 px-4 md:px-10 bg-white z-1 border-b border-[#e6e6e6] flex items-center justify-between">
      {/* Left side - Home title */}
      <h1 className="heading_text">PopUp Forms</h1>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <button 
            className="px-4 py-1.5 border border-[#d9d9d9] rounded-md bg-white text-[#333] hover:bg-gray-50 flex items-center gap-2 text-sm font-medium transition-colors"
            aria-haspopup="true"
            aria-expanded="false"
          >
            <span>Settings</span>
