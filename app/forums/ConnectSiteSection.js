  ...
  return (
    <div className="max-w-[1248px] mx-auto px-6 py-8">
      ...
      <div className="flex flex-col md:flex-row border border-[#e6e6e6] rounded-lg mb-8 overflow-hidden">
        ...
        <div className="bg-[#d99536] w-full md:w-[200px] p-6 flex items-center justify-center relative">
          <div className="relative">
            {/* Browser icon */}
            <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-10 h-6 bg-white rounded-full flex items-center justify-center z-10">
            ...
            <div className="bg-white rounded-md shadow-sm overflow-hidden w-[150px]">
              {/* Browser toolbar */}
              <div className="h-3 bg-[#f5f5f5] border-b border-[#e6e6e6] flex items-center px-2">
        ...
        <div className="p-2 md:p-4 flex-1 bg-white">
          <h2 className="text-[20px] font-[550] text-[#21262A] mb-2">
      ...
      <div className="border border-[#e6e6e6] rounded-lg p-4 px-6">
        <h2 className="text-[24px] font-[550] text-[#21262A] mb-8">All popup forms</h2>
        
        <div className="text-center max-w-[600px] mx-auto">
          <h3 className="text-[20px] font-[550] text-[#241c15] mb-2">
