    ...
    <div className="max-w-[1148px] mx-auto px-6 py-8">
      ...
      <div className="flex flex-col md:flex-row border border-[#e6e6e6] rounded-lg mb-8 overflow-hidden">
        ...
        <div className="p-6 md:p-8 flex-1 bg-white">
          ...
          <button className="px-8 py-1 bg-white border border-[#007c89] text-[#007c89] rounded-lg hover:bg-[#f7f7f7] transition-colors font-medium">
            Connect site
          </button>
        </div>
      </div>
      ...
      <div className="border border-[#e6e6e6] rounded-lg p-8">
        ...
        <div className="text-center max-w-[600px] mx-auto">
          ...
          <button className="px-6 py-1 bg-white border border-[#007c89] rounded-lg hover:bg-[#f7f7f7] transition-colors font-medium">
            Create popup form
          </button>
        </div>
      </div>
