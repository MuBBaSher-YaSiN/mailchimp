  ...
  return (
    <div className="max-w-[1248px] mx-auto px-6 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3  gap-5">
        ...
        <div className="border border-[#e6e6e6] rounded-xl hover:border-zinc-600 p-2 px-4 bg-white lg:w-full">
        ...
        <div className="border border-[#e6e6e6] rounded-xl hover:border-zinc-600 p-2 px-4 bg-white">
