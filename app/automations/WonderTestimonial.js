...
export default function WonderTestimonial() {
    return (
        <section className="max-w-5xl mx-auto px-6 lg:px-2 py-20 lg:my-8">
            <div className="flex flex-col lg:flex-row items-center md:items-start gap-1 md:gap-16">
                ...
                <div className="lg:max-w-[50%] flex-1 ">
                    ...
                    <div>
                        ...
                        <p className="text-[#676767] text-sm my-3">
