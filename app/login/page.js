        ...
        <div className="p-3 h-screen max-lg:border-t-8 lg:border-l-8 border-yellow-300">
            ...
            <div className="flex items-center justify-center mt-6">
                <div className="w-full max-w-[480px] py-4 px-7 border border-zinc-300 rounded-xl">
                    ...
                    <h1 className="text-[32px] mb-4 text-center text-[#241C15] " style={{ fontWeight: 600 }}>
                        Log in to Mailchimp
                    </h1>

                    <div className="text-center mb-6 text-[17px]">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-4">
                            <label htmlFor="email" className="block text-[#21262a] text-[16px] font-semibold mb-2">
                                Username or Email
                            </label>
                            <input
                                id="email"
                        ...
                        <div className="mb-6">
                            <div className="flex justify-between items-center mb-2">
                                <label htmlFor="password" className="block text-[#21262a] font-semibold">
                                    Password
                                </label>
                                <button
                                    type="button"
                        ...
                        <div className="mb-4 flex items-center">
                            ...
                            />
                            <label htmlFor="rememberMe" className="ml-2 font-semibold text-[#241C15]">
                                Keep me logged in
                            </label>
                        </div>
                    ...
                    <div className="flex max-w-[320px] mx-auto justify-between mt-4 text-[16px]">
                        <Link href="/forgot-username" className="text-[#007C89] underline font-semibold ">
                            Forgot username?
                        </Link>
                        <Link href="/forgot-password" className="text-[#007C89] underline font-semibold">
                            Forgot password?
                        </Link>
                    </div>

                    <div className="my-5 pt-6 text-[16px] text-center text-gray-500 border-t border-[#E6E6E6]">
                        <p className="mb-4 p-0 text-shadow-sm">
                            Or, if you created your Mailchimp account with Google:
                        </p>

                        <button
                            type="button"
                            className="w-full border rounded py-2 flex justify-center items-center"
                        >
