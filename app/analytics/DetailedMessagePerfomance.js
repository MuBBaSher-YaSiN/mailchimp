    ...
    return (
        <div className='text-[21262A] my-8'>
            <div className='flex justify-between items-center'>
                <div>
                    <p className='text-[20px] font-semibold text-black'>Detailed message performance</p>
                ...
                <div className='flex gap-4'>
                    <button className='border border-gray-300 rounded px-7 py-1 font-semibold'>Go to custom reports</button>
