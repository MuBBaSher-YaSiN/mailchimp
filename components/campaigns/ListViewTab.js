        ...
        <table className="w-full min-w-[800px]">
          ...
          <tbody>
            <tr className="border-b border-gray-200 hover:bg-gray-50">
              ...
              <td className="py-4 px-3 min-w-[300px] xl:w-[416px] flex flex-col gap-1">
                <div className="mb-1">
                ...
                <span className="w-fit items-center px-2.5 py-0.5 my-3 rounded-md text-xs font-medium bg-[#e2e9ed] text-gray-800">
                  Draft
                </span>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-5">
        ...
        <div className="flex items-center space-x-2">
          ...
          <input
            type="text"
            value="1"
            className="w-12 py-1 px-2 text-center border border-gray-300 h-[32px] rounded text-sm bg-[#d5dee3]"
          />

          <span className="text-sm whitespace-nowrap">of 1</span>
